...
class MultiFileWriter:
    ...
    def __init__(self, base_dir, name, index_name, bucket_name):
    ...
    def read(self, locs, n_bytes, index_name):
        ...
        for f_name, offset in locs:
            if f_name not in self._open_files:
                self._open_files[f_name] = open(f'{index_name}/{f_name}', 'rb')
...
class InvertedIndex:
    ...
    def posting_lists_iter(self, index_name, query):
        """ A generator that reads one posting list from disk and yields
            a (word:str, [(doc_id:int, tf:int), ...]) tuple.
        """
        with closing(MultiFileReader()) as reader:
            for w in query:
                b = reader.read(self.posting_locs[w], self.df[w] * TUPLE_SIZE, index_name)
                posting_list = []
    ...
    @staticmethod
    def write_a_posting_list(b_w_pl, index_name, bucket_name):
        ...
        with closing(MultiFileWriter('.', bucket_id, index_name, bucket_name)) as writer:
            ...
            #adding here index_name checkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk
    ...
    def _upload_posting_locs(bucket_id, posting_locs, bucket_name, index_name):
        ...
        blob_posting_locs = bucket.blob(f"{index_name}/{bucket_id}_posting_locs.pickle")
